...
import org.gradle.model.internal.core.FactoryBasedStructInitializer;
...
public class FactoryBasedNodeInitializerExtractionStrategy<T> implements NodeInitializerExtractionStrategy {
    ...
    private <S extends T> NodeInitializer getNodeInitializer(final ModelSchema<S> schema) {
        ...
        return new FactoryBasedStructInitializer<T, S>(instanceFactory, managedSchema, schemaStore, proxyFactory, new Action<T>() {
            @Override
