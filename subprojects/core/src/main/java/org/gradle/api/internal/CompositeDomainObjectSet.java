...
public class CompositeDomainObjectSet<T> extends DelegatingDomainObjectSet<T> implements WithEstimatedSize {
    ...
    public static <T> CompositeDomainObjectSet<T> create(Class<T> type, DomainObjectCollection<? extends T>... collections) {
        ...
        DefaultDomainObjectSet<T> backingSet = new DefaultDomainObjectSet<T>(type, new MyCompositeCollection());
    ...
    protected MyCompositeCollection getStore() {
        return (MyCompositeCollection) this.backingSet.getStore();
    }
    ...
    public Iterator<T> iterator() {
        MyCompositeCollection store = getStore();
        if (store.isEmpty()) {
    ...
    private final static class MyCompositeCollection<T> implements Collection<T>, WithEstimatedSize {

        private final List<DomainObjectCollection<? extends T>> store = Lists.newArrayList();
